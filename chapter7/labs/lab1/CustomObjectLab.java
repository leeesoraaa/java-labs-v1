...
public class CustomObjectLab {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("A1234", "아무도 없는 바다", "최유수", 12000);
        Book book2 = new Book("A1234", "아무도 없는 바다", "최유수", 12000);

        Book book3 = new Book("B1234", "아무도 없는 바다", "최유수", 12000);
        // TODO: equals() 메소드 테스트
        ...
        System.out.println("book1.equals(2): "+  book1.equals(2));
        ...
        map.put(book1, book1.toString());
        map.put(book3, book3.toString());
        ...
        bookList.add(book1);
        bookList.add(book3);
        System.out.println("bookList.contains(book1): "+bookList.contains(book1));
        System.out.println("bookList.contains(book2: "+bookList.contains(book2));
        System.out.println("bookList.contains(book3): "+bookList.contains(book3));
